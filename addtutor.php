...
<?php
	...
	if (!isset($_SESSION['login']) || $_SESSION['login'] == '') {
        ...
        if (count($_POST)) {
            add_tutor ($_POST['name'], $_POST['email'], $_POST['major'], $_POST['class1'], $_POST['class2'], $_POST['class3'], $_POST['class4'], $_POST['availability']);
...
<html lang="en">
    ...
    <head>
        ...
        <script type="text/javascript" src="js/chkTutor.js"></script>
    </head>
    ...
    <body>
        ...
        <div class="container">
            ...
            <form id="addTutor" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" onsubmit="validateTutor()">
                <h2>Offer Help</h2>
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-control" name="email" id="idEmail" placeholder="Enter email">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea name="availability" class="form-control" rows="3" id="availability"></textarea>
                </div>
